...
## Step 2: Base Strategy Implementation
...
## Step 4: Walk-Forward Optimization (WFO) Framework
...
- [ ] Integrate purged CV into core parameter optimization (Stage 4.1)
- [ ] Integrate purged CV into RF threshold tuning (Stage 4.2)

## Step 6: Feature Selection via Shallow Random Forest
